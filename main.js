...
function changeIceCream() {
  ...
  icecream.classList.remove("drop-animation");

  void icecream.offsetWidth;

  icecream.src = images[index];

  icecream.classList.add("drop-animation");
}

setInterval(changeIceCream, 3500);